        ...
        void Start()
        {
            ...
            for (int i = MinPointSize; i <= MaxPointSize; i += Steps)
            {
                ...
                else
                {
                    ...
                    /*
                    GameObject go = new GameObject("Arial " + _currentMonsterIndex);
                    ...
                    textMesh.fontSize = _currentMonsterIndex * 10;

                    textMesh.color = new Color32(255, 255, 255, 255);
                    textMesh.text = _currentMonsterIndex + " pts - Lorem ipsum dolor sit...";

                    lineHeight += _currentMonsterIndex;
                    */
                }
            }
        }
